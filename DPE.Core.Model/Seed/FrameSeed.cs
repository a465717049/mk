...
namespace DPE.Core.Model.Models
{
    public class FrameSeed
    {
        ...
        public static bool CreateModels(SqlSugarClient sqlSugarClient, string ConnId, string[] tableNames = null)
        {
            ...
            try
            {
                Create_Model_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"C:\my-file\DPE.Core.Model", "DPE.Core.Model.Models", tableNames, "");
                return true;
            }
            catch (Exception)
            {
        ...
        public static bool CreateIRepositorys(SqlSugarClient sqlSugarClient, string ConnId, string[] tableNames = null)
        {
            ...
            try
            {
                Create_IRepository_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"C:\my-file\DPE.Core.IRepository", "DPE.Core.IRepository", tableNames, "");
                return true;
            }
            catch (Exception)
            {
        ...
        public static bool CreateIServices(SqlSugarClient sqlSugarClient, string ConnId, string[] tableNames = null)
        {
            ...
            try
            {
                Create_IServices_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"C:\my-file\DPE.Core.IServices", "DPE.Core.IServices", tableNames, "");
                return true;
            }
            catch (Exception)
            {
        ...
        public static bool CreateRepository(SqlSugarClient sqlSugarClient, string ConnId, string[] tableNames = null)
        {
            ...
            try
            {
                Create_Repository_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"C:\my-file\DPE.Core.Repository", "DPE.Core.Repository", tableNames, "");
                return true;
            }
            catch (Exception)
            {
        ...
        public static bool CreateServices(SqlSugarClient sqlSugarClient, string ConnId, string[] tableNames = null)
        {
            ...
            try
            {
                Create_Services_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"C:\my-file\DPE.Core.Services", "DPE.Core.Services", tableNames, "");
                return true;
            }
            catch (Exception)
            {
...
using DPE.Core.Model.Models." + ConnId + @";
    ...
    public interface I{ClassName}Services :IBaseServices<{ClassName}>" + (string.IsNullOrEmpty(strInterface) ? "" : (" , " + strInterface)) + @"
	{
          ...
          string strInterface)
        {
            ...
            var ls = IDbFirst.IsCreateDefaultValue().IsCreateAttribute()
                  ...
                  .SettingClassTemplate(p => p =
@"using DPE.Core.IRepository." + ConnId + @";
    ...
    public class {ClassName}Repository : BaseRepository<{ClassName}>, I{ClassName}Repository" + (string.IsNullOrEmpty(strInterface) ? "" : (" , " + strInterface)) + @"
    {
          ...
          string strInterface)
        {
            ...
            var ls = IDbFirst.IsCreateDefaultValue().IsCreateAttribute()
                  ...
                  .SettingClassTemplate(p => p =
@"using DPE.Core.IRepository." + ConnId + @";
using DPE.Core.IServices." + ConnId + @";
using DPE.Core.Model.Models." + ConnId + @";
