...
export default {
  props: {
    ...
    easingFn: {
      type: Function,
      default(t, b, c, d) {
        return (c * (-Math.pow(2, (-10 * t) / d) + 1) * 1024) / 800 + b
      }
    }
  },
  data() {
  ...
  methods: {
    ...
    resume() {
      ...
      this.localStartVal = this.localStartVal + this.printVal + 100
    ...
    count(timestamp) {
      ...
      // this.printVal=this.printVal+100
      // console.log(this.printVal,'this.printVal')
