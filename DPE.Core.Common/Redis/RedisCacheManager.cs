...
namespace DPE.Core.Common
{
    public class RedisCacheManager : IRedisCacheManager
    {
        ...
        public RedisCacheManager()
        {
            ...
            string _password = Appsettings.app(new string[] { "AppSettings", "RedisCachingAOP", "Password" });//获取连接密碼
        ...
        public void SetString(string key, object value, TimeSpan cacheTime)
        {
            if (value != null)
            {
                //序列化，将object值生成RedisValue
                redisConnection.GetDatabase().StringSet(key, value.ToString(), cacheTime);
            }
        }
