<template>
  <section>
    ...
    <el-select style="width:202px" v-model="searchstatusVal" placeholder="类型">
      ...
      <el-option value="4" label="銷售">銷售</el-option>
      <el-option value="6" label="創建子賬號">創建子賬號</el-option>
      <el-option value="7" label="創建新賬號">創建新賬號</el-option>
      <el-option value="8" label="RP轉SP">RP轉SP</el-option>
      <el-option value="9" label="EP轉SP">EP轉SP</el-option>
...
export default {
  ...
  methods: {
    ...
    getUsers() {
      ...
      //NProgress.start();
      GetAdminSPExchange(para).then((res) => {
