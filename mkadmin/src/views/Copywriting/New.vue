<template>
  <section>
    ...
    <el-table :data="users" highlight-current-row @current-change="selectCurrentRow" v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
      ...
      <el-table-column prop="uid" label="玩家ID" width="" sortable>
      </el-table-column>
      <el-table-column prop="amount" label="出售数量" width="" sortable>
      </el-table-column>
         <el-table-column prop="epamount" label="EP余额" width="" sortable>
      </el-table-column>
    </el-table>
...
export default {
  ...
  methods: {
    ...
    getUsers() {
      ...
      testapi();
      //NProgress.start();
      GetEPFinanceSell(para).then((res) => {
