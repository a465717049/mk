...
namespace DPE.Core.AuthHelper
{
    ...
    public class PermissionHandler : AuthorizationHandler<PermissionRequirement>
    {
        ...
        public PermissionHandler(IRedisCacheManager redisCacheManager,IAuthenticationSchemeProvider schemes, IRoleModulePermissionServices roleModulePermissionServices, IHttpContextAccessor accessor)
        {
            _accessor = accessor;
            Schemes = schemes;
        ...
        protected override async Task HandleRequirementAsync(AuthorizationHandlerContext context, PermissionRequirement requirement)
        {
            ...
            if (Appsettings.app("Startup", "DEV_NO_PROTECTION").ObjToBool())
            {
                try
                {
