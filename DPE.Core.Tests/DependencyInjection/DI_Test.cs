...
using DPE.Core.Common.AppConfig;
using System.Text;
...
namespace DPE.Core.Tests
{
    public class DI_Test
    {
        ...
        public void DI_Connet_Test()
        {
            ...
            //var assemblysServices = Assembly.Load("DPE.Core.Services");
            //builder.RegisterAssemblyTypes(assemblysServices).AsImplementedInterfaces();
            //var assemblysRepository = Assembly.Load("DPE.Core.Repository");
            //builder.RegisterAssemblyTypes(assemblysRepository).AsImplementedInterfaces();

            var servicesDllFile = Path.Combine(basePath, "DPE.Core.Services.dll");
            ...
            var repositoryDllFile = Path.Combine(basePath, "DPE.Core.Repository.dll");
        ...
        public IContainer DICollections()
        {
            ...
            services.AddScoped<DPE.Core.Model.Models.DBSeed>();
            services.AddScoped<DPE.Core.Model.Models.MyContext>();
